            ...
            <div className="container">
               <div className="mx-auto mt-24 w-full max-w-5xl">
                  <div className="rounded-lg border p-8 shadow-xl">
                     <h3 className="text-center font-quando text-2xl font-semibold">Log In</h3>
                     ...
                     <form>
                        ...
                        <div className="my-7 mx-auto flex w-full max-w-sm justify-center">
                           <button className="w-1/2 rounded-lg bg-blue-700 py-1.5 font-quando text-base text-white hover:bg-blue-800">
